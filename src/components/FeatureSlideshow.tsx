...
const SLIDES: FeatureSlide[] = [
  {
    ...
    body: 'Observations appear in real-time. One shared map replaces scattered notebooks, WhatsApp groups, and chat histories — reducing duplicates and making every sighting count for science.',
  ...
  {
    id: 'community',
    title: 'Birding, finally modern.',
    body: 'Existing platforms feel stuck in 2010. Fink solves a UX problem — making observation entry intuitive, archiving satisfying, and community features feel natural. Not a game. Just birding, done right.',
  ...
  },
  {
    ...
    body: 'Advanced pattern matching trained on verified observations. Enter what you saw or upload a photo — our algorithms identify the species and score the confidence. Every ID improves the system.',
  ...
  },
  {
    ...
    body: 'A clean species list with photos, locations, and dates — organized automatically. Your observations become your personal bird story. Export anytime in digestible, research-compatible formats.',
